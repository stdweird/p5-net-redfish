...
Net::Redfish::Error is an error class for Net::Redfish.
...
A C<Net::Redfish::Error> factory

=cut

sub mkerror
{
    return Net::Redfish::Error->new(@_);
}
