...
is_deeply(\%Net::Redfish::Error::ERROR_CODES, {
...
$e = Net::Redfish::Error->new();
isa_ok($e, 'Net::Redfish::Error', 'Created a Net::Redfish::Error instance');
...
=cut
=begin GHOSTCODE
my $nf = $Net::Redfish::Error::NOT_FOUND;
my $nfc = $Net::Redfish::Error::ERROR_CODES{$nf};
